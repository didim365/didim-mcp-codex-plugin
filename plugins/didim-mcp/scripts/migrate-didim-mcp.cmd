...
chcp 65001 >nul
setlocal
rem Double-click launcher for migrate-didim-mcp.ps1.
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0migrate-didim-mcp.ps1"
set "RC=%ERRORLEVEL%"
echo.
if "%RC%"=="0" (
  echo Done. You can close this window.
) else (
  echo Cleanup did not complete. Exit code: %RC%. See the messages above.
)
echo.
pause
endlocal
